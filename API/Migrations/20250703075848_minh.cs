    ...
    public partial class minh : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("165f8784-7583-4a86-874c-99c09096235a"), "Cỡ giày 48", "Size 48", true, 48 },
                    { new Guid("4a78b505-8da6-42c3-8a7c-b83e389c9e5f"), "Cỡ giày 49", "Size 49", true, 49 },
                    { new Guid("54d0a3b3-8b65-4902-9af2-319c1edde819"), "Cỡ giày 39", "Size 39", true, 39 },
                    { new Guid("6642ad57-d9da-4109-82b7-98bfa7eda5be"), "Cỡ giày 41", "Size 41", true, 41 },
                    { new Guid("6d7d4b8b-c6d4-4884-83be-ecff834ee318"), "Cỡ giày 38", "Size 38", true, 38 },
                    { new Guid("6ee85562-7acc-414c-8414-e16bf8758943"), "Cỡ giày 46", "Size 46", true, 46 },
                    { new Guid("842a19a5-fbfb-40e4-a58e-37af1c7080a9"), "Cỡ giày 35", "Size 35", true, 35 },
                    { new Guid("854145eb-5623-4efb-9ba2-d19b6791c5a3"), "Cỡ giày 42", "Size 42", true, 42 },
                    { new Guid("95ce69f2-70e7-42fe-92c9-a4b03e6264ba"), "Cỡ giày 43", "Size 43", true, 43 },
                    { new Guid("a77fddb2-9dd8-4c67-aeef-abf8ad95ff31"), "Cỡ giày 37", "Size 37", true, 37 },
                    { new Guid("ab66fee8-339f-40b8-93fa-4fa97dc80e6e"), "Cỡ giày 45", "Size 45", true, 45 },
                    { new Guid("acda66cb-b870-4a81-89c1-4c66250b6b2d"), "Cỡ giày 47", "Size 47", true, 47 },
                    { new Guid("bc17277c-0d93-429f-a3d0-bb98d2d9aa0a"), "Cỡ giày 50", "Size 50", true, 50 },
                    { new Guid("bc88dbfb-a16d-4fa0-add4-b6a1367ef049"), "Cỡ giày 40", "Size 40", true, 40 },
                    { new Guid("bec8c74b-e782-4178-bd67-cb0dea1c3e69"), "Cỡ giày 44", "Size 44", true, 44 },
                    { new Guid("f0ccdd32-c3aa-4582-beec-1bbbf7fc95c7"), "Cỡ giày 36", "Size 36", true, 36 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("19f20f6f-12b5-458c-9c04-569c48b768e0"), "#FFFF00", "Màu vàng", "Vàng", true },
                    { new Guid("1e02f6d2-f62e-466e-8821-7b867c3d79c0"), "#00FF00", "Màu xanh lá cây", "Xanh lá", true },
                    { new Guid("6018239a-652c-4ebc-9813-2aab4568e52e"), "#000000", "Màu đen", "Đen", true },
                    { new Guid("7630f1c6-3a4b-4ed5-ae22-71a108fd6b33"), "#0000FF", "Màu xanh dương cơ bản", "Xanh dương", true },
                    { new Guid("aa20d125-0dd8-4036-afdb-8ceec389bbff"), "#FF0000", "Màu đỏ cơ bản", "Đỏ", true },
                    { new Guid("c95cbf43-735a-44be-a052-120e48fc9f47"), "#FFFFFF", "Màu trắng", "Trắng", true }
                });

            migrationBuilder.InsertData(
                table: "TaiKhoans",
                columns: new[] { "TaikhoanId", "Ngaytaotaikhoan", "Password", "Username" },
                values: new object[] { new Guid("99999999-9999-9999-9999-999999999999"), new DateTime(2025, 7, 3, 14, 58, 47, 222, DateTimeKind.Local).AddTicks(6528), "admin123", "admin" });

            migrationBuilder.InsertData(
                table: "NhanViens",
                columns: new[] { "NhanVienId", "ChucVuId", "Email", "HoTen", "NgayCapNhatCuoiCung", "NgaySinh", "SoDienThoai", "TaikhoanId", "TrangThai" },
                values: new object[] { new Guid("88888888-8888-8888-8888-888888888888"), new Guid("11111111-1111-1111-1111-111111111111"), "admin@shop.com", "Nguyễn Văn Quản Trị", new DateTime(2025, 7, 3, 14, 58, 47, 222, DateTimeKind.Local).AddTicks(6600), new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "0987654321", new Guid("99999999-9999-9999-9999-999999999999"), true });
